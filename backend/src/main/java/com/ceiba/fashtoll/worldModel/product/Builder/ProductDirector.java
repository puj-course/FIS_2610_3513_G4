...
public class ProductDirector {
    ...
    public void makeCompleteProduct(ProductCreateRequest request){
        this.builder.reset();
        boolean available = false;
        if(request.getAvailable() != null) available = request.getAvailable();
    ...
    public void adminUpdateCompleteProduct(Long productId, ProductAdminUpdateRequest request){
        this.builder.reset();
        this.builder.adminUpdateProduct(productId);
    ...
    public void updateCompleteProduct(Long brandId, Long productId, ProductUpdateRequest request){
        this.builder.reset();
        this.builder.adminUpdateProduct(productId);
